...
class SettingFragment : PreferenceFragment(), Preference.OnPreferenceClickListener, Preference.OnPreferenceChangeListener {
    ...
    private var mWatcherSwitch: CheckBoxPreference? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mWatcherSwitch = findPreference(SharedPreferenceUtil.WATCHER) as CheckBoxPreference
        ...
        mWatcherSwitch!!.isChecked = SharedPreferenceUtil.instance.watcherSwitch
        if (Build.VERSION.SDK_INT >= 23 && !Settings.canDrawOverlays(context)) {
            mWatcherSwitch!!.isEnabled = false
        }
        ...
        mWatcherSwitch!!.onPreferenceChangeListener = this
    }
    ...
    private fun showUpdateDialog() {
        ...
        tvShowHour.text = String.format("每%s小时", mSeekBar.progress)
        alertDialog.show()
        ...
        tvDone.setOnClickListener { v ->
            ...
            activity.startService(Intent(activity, AutoUpdateService::class.java))
            alertDialog.dismiss()
        }
    }
